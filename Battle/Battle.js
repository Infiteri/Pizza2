class Battle {
  constructor({ enemy, map, onComplete }) {
    this.enemy = enemy //Combatant
    this.map = map //OverworldMap
    this.onComplete = onComplete //Function || resolver

    //To be filled later
    this.combatants = {}

    //Active combatants that will be shown
  ...
  //Add combatant to the combatants
