        ...
        talking: [
          ...
          },
          {
            events: [
              {
                type: 'textMessage',
                text: "I'm going to teach you how to fight!",
                faceHero: 'npcA',
              },
      ...
      [utils.asGridCoord(3, 7)]: [
        {
          events: [
            {
              type: 'textMessage',
              text: 'Here you can get pizzas... Once used you cant re-use it.',
            },
          ],
        },
      ],
        ...
        talking: [
          ...
          },
          {
            events: [
              {
                type: 'textMessage',
                text: 'Going to Tony Boiiis today?',
                faceHero: 'npcA',
              },
              {
                type: 'textMessage',
              ...
              { type: 'addStoryFlag', flag: 'TALKEDTOTONY' },
            ],
          },
          {
            required: ['TONYBOIIS'],
  ...
  PizzaShop: {
    ...
    gameObjects: {
      ...
      seller: new Person({
        ...
        talking: [
          {
            required: ['BOUGHT_KALE'],
            events: [
              { type: 'textMessage', text: 'Can I buy another pizza?' },
              { type: 'textMessage', text: 'I told you I have only one.' },
            ],
          },
          {
            events: [
              { type: 'textMessage', text: 'Can I buy a pizza?' },
              {
                type: 'textMessage',
                text: 'Sure, I have only one called "Call me Kale"',
              },
              { type: 'addStoryFlag', flag: 'BOUGHT_KALE' },
              {
                type: 'addPizza',
                pizzaId: 'v001',
              },
      ...
      [utils.asGridCoord(5, 12)]: [
        {
          events: [
            ...
            { type: 'addStoryFlag', flag: 'TONYBOIIS' },
          ],
        },
      ],
    },
